import { serialize } from '../submissionProblemScores.serializer'
...
describe('SubmissionProblemScore Serializer', () => {
    beforeEach(() => {
        ...
        mockSubmissionProblemScore.release = new Date()
    ...
    describe('Serializing submissionProblemScore', () => {
        ...
        test('release, createdAt, and updatedAt are ISO strings for all submissions', () => {
            ...
            expect(expectedResult).toBeDefined()
            expect(expectedResult.release).toEqual(mockSubmissionProblemScore.release?.toISOString())
