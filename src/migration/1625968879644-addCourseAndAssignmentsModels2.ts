...
export class addCourseAndAssignmentsModels1625968879644 implements MigrationInterface {
    name = 'addCourseAndAssignmentsModels1625968879644'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "assignments" ("id" SERIAL NOT NULL, "name" character varying(128) NOT NULL, "start_date" TIMESTAMP NOT NULL, "due_date" TIMESTAMP NOT NULL, "end_date" TIMESTAMP NOT NULL, "grading_type" character varying(128) NOT NULL, "category_name" character varying(128) NOT NULL, "description" character varying, "max_file_size" integer NOT NULL, "max_submissions" integer NOT NULL, "disable_handins" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "course_id" integer, CONSTRAINT "assignments_primary_key_constraint" PRIMARY KEY ("id"))`);
